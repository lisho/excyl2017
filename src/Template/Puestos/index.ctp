...
<div class="puestos index large-9 medium-8 columns content">
    <h3><?= __('Puestos') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $puesto->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $puesto->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $puesto->id], ['confirm' => __('Are you sure you want to delete # {0}?', $puesto->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
