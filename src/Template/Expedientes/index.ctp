...
<div class="expedientes index large-9 medium-8 columns content">
    <h3><?= __('Expedientes') ?></h3>
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                <th scope="col"><?= $this->Paginator->sort('id') ?></th>
                <th scope="col"><?= $this->Paginator->sort('numedis') ?></th>
                <th scope="col"><?= $this->Paginator->sort('numhs') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $expediente->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $expediente->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $expediente->id], ['confirm' => __('Are you sure you want to delete # {0}?', $expediente->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
