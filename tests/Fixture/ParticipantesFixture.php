...
class ParticipantesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'email' => ['type' => 'string', 'length' => 250, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'foto' => ['type' => 'string', 'length' => 200, 'null' => true, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'desactivado' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'relation_id' => 1,
            'nacimiento' => '2017-05-13',
            'expediente_id' => 1,
            'desactivado' => 1,
            'created' => '2017-05-13 11:03:36',
            'modified' => '2017-05-13 11:03:36'
        ],
    ];
}
